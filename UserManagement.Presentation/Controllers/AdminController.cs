...
namespace UserManagement.Presentation.Controllers
{
    ...
    public sealed class AdminController : ApiController
    {
        ...
        [HttpPost("toggle-vendor-activation")]
        public async Task<IActionResult> ToggleVendorActivation([FromBody] ToggleUserAccountActivationCommand request, CancellationToken cancellationToken)
        {
        ...
        public async Task<IActionResult> ToggleSupervisorActivation([FromQuery] ToggleUserAccountActivationCommand request, CancellationToken cancellationToken)
        {
            var result = await Sender.Send(request, cancellationToken);
            return HandleResult(result);
        }
        ...
        public async Task<IActionResult> ToggleCustomerActivation([FromQuery] ToggleUserAccountActivationCommand request, CancellationToken cancellationToken)
        {
            var result = await Sender.Send(request, cancellationToken);
            return HandleResult(result);
        }
